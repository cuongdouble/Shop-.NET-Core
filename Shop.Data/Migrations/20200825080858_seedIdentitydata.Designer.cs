...
namespace Shop.Data.Migrations
{
    ...
    [Migration("20200825080858_seedIdentitydata")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop.Data.Entities.AppConfig", b =>
                {
            ...
            modelBuilder.Entity("Shop.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "7c695450-83a0-4be3-9c13-4ed745838d8c",
            ...
            modelBuilder.Entity("Shop.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3860ac1d-b8f9-4f24-ac9a-34a57080d46b",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEIhfQjc2232OT6dXicr9alaYn/d9Xv3gy/h1cqngl2kNhIL9gWfHOIPx5wBp0AqVvg==",
            ...
            modelBuilder.Entity("Shop.Data.Entities.CategoryTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Shop.Data.Entities.Language", b =>
                {
            ...
            modelBuilder.Entity("Shop.Data.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("OrderDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 8, 25, 15, 8, 57, 771, DateTimeKind.Local).AddTicks(1992));
            ...
            modelBuilder.Entity("Shop.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2020, 8, 25, 15, 8, 57, 790, DateTimeKind.Local).AddTicks(5907),
            ...
            modelBuilder.Entity("Shop.Data.Entities.ProductTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Shop.Data.Entities.CategoryTranslation", b =>
                {
                    ...
                    b.HasOne("Shop.Data.Entities.Language", "Language")
                        .WithMany("CategoryTranslations")
